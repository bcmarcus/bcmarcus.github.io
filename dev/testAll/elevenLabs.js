...
const { logDebug, logWarning } = require('../../routes/utils/logging.js');
...
async function elevenLabsStreamToTwilio(ws, twilioStreamSid, message) {
  if (!ws || !twilioStreamSid || !message || typeof message !== "string"){
    logWarning(`elevenLabsStreamToTwilio invalid args: ws=${ws}, twilioStreamSid=${twilioStreamSid}, message=${message}`)
    return;
  }
