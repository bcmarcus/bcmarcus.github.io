    ...
    <FormLayout>
      ...
      <div className="theme-secondary flex flex-col items-center justify-center smooth-transition">
        <form onSubmit={handleSubmit} className="w-full max-w-6xl">
          ...
          <Checkbox label="I agree to the " url="/privacy-policy" urlTitle="Privacy Policy" required />
          <Checkbox label="I agree to the " url="/terms" urlTitle="Terms and Conditions" required />
