...
const TermsAndConditions = () => {
  return (
    <HomeLayout>
      {/* <RecaptchaV3 /> */}
      <div className="text-black background-white flex-grow flex flex-col items-center justify-center">
        <h1 className="home-title">Vulpine AI Terms and Conditions</h1>
        ...
        <div className="mx-8 text-xl">
          ...
          <p>
            ...
            <br></br>
            These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Vulpine AI, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
            <br></br>
          ...
          &emsp;<LinkToID url="#our-services" urlTitle="1. OUR SERVICES"></LinkToID> <br/>
          &emsp;<LinkToID url="#intellectual-property-rights" urlTitle="2. INTELLECTUAL PROPERTY RIGHTS"></LinkToID> <br/>
          &emsp;<LinkToID url="#user-representations" urlTitle="3. USER REPRESENTATIONS"></LinkToID> <br/>
          &emsp;<LinkToID url="#prohibited-activities" urlTitle="4. PROHIBITED ACTIVITIES"></LinkToID> <br/>
          &emsp;<LinkToID url="#user-generated-contributions" urlTitle="5. USER GENERATED CONTRIBUTIONS"></LinkToID> <br/>
          &emsp;<LinkToID url="#contribution-license" urlTitle="6. CONTRIBUTION LICENSE"></LinkToID> <br/>
          &emsp;<LinkToID url="#services-management" urlTitle="7. SERVICES MANAGEMENT"></LinkToID> <br/>
          &emsp;<LinkToID url="#term-and-termination" urlTitle="8. TERM AND TERMINATION"></LinkToID> <br/>
          &emsp;<LinkToID url="#modifications-and-interruptions" urlTitle="9. MODIFICATIONS AND INTERRUPTIONS"></LinkToID> <br/>
          &emsp;<LinkToID url="#governing-law" urlTitle="10. GOVERNING LAW"></LinkToID> <br/>
          &emsp;<LinkToID url="#dispute-resolution" urlTitle="11. DISPUTE RESOLUTION"></LinkToID> <br/>
          &emsp;<LinkToID url="#corrections" urlTitle="12. CORRECTIONS"></LinkToID> <br/>
          &emsp;<LinkToID url="#disclaimer" urlTitle="13. DISCLAIMER"></LinkToID> <br/>
          &emsp;<LinkToID url="#limitations-of-liability" urlTitle="14. LIMITATIONS OF LIABILITY"></LinkToID> <br/>
          &emsp;<LinkToID url="#indemnification" urlTitle="15. INDEMNIFICATION"></LinkToID> <br/>
          &emsp;<LinkToID url="#user-data" urlTitle="16. USER DATA"></LinkToID> <br/>
          &emsp;<LinkToID url="#electronic-communications-transactions-and-signatures" urlTitle="17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES"></LinkToID> <br/>
          &emsp;<LinkToID url="#miscellaneous" urlTitle="18. MISCELLANEOUS"></LinkToID> <br/>
          &emsp;<LinkToID url="#contact-us" urlTitle="19. CONTACT US"></LinkToID> <br/>
          ...
          <h2 id="term-and-termination">8. TERM AND TERMINATION</h2>
          <p>
          ...
          <h2 id="modifications-and-interruptions">9. MODIFICATIONS AND INTERRUPTIONS</h2>
          <p>
          ...
          <h2 id="limitations-of-liability">14. LIMITATIONS OF LIABILITY</h2>
          <p>
          ...
          <h2 id="electronic-communications-transactions-and-signatures">17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
          <p>
